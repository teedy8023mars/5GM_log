...
class App:
    def __init__(self, win):
        ...
        self.filename = ''
        self.textbox = Text(self.top_frame, bg='lightcyan', yscrollcommand=self.scrollbar.set,
        ...
        self.toggle = Button(self.right_frame, text="Start  /  Stop",
                             command=self.change_state, bg="dodgerblue")
    ...
    def change_state(self):
        if self.continueLogging == True:
            ...
            try:
                ...
                pass
            # threading.Thread(target=self.logger)._stop()
        else:
